...
def get_entity_purpose(entity_type: str) -> str:
    """Возвращает назначение сущности"""
    purposes = {
        "contract_number": "Идентификация договора в системе",
        "date": "Определение сроков действия и ключевых дат",
        "inn": "Идентификация контрагентов в налоговой системе",
        "ogrn": "Подтверждение регистрации юридического лица",
        "kpp": "Код причины постановки на учет",
        "amount": "Финансовые условия договора",
        "organization": "Определение сторон договора",
        "person": "Идентификация представителей сторон",
        "address": "Юридические и фактические адреса сторон",
        "phone": "Контактная информация",
        "email": "Электронная связь",
        "account": "Банковские реквизиты для расчетов",
        "bic": "Идентификация банка",
        "percent": "Проценты, штрафы, скидки"
    }
    return purposes.get(entity_type, "Дополнительная информация")
