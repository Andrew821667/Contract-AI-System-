...
**Статус:** Персональный демо-доступ реализован; отдельная устаревшая Python-админка удалена.
**Ветка:** fix/request-demo-access-20260716
...
- [ ] Сверить параллельные изменения пользователя, опубликовать PR и проверить production.
