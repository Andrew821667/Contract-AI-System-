...
**Статус:** LLM-маршрутизация DeepSeek V4 Flash/Pro опубликована и проверена в production.
**Ветка:** main

---

## ТЕКУЩАЯ ЗАДАЧА — DEEPSEEK FLASH ПО УМОЛЧАНИЮ
...
- Стандартная модель: `deepseek-v4-flash`, всегда `thinking: disabled`.
