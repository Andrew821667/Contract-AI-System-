...
**Статус:** LLM-маршрутизация переведена на DeepSeek V4 Flash/Pro; готовится production-деплой.
**Ветка:** main
...
- [ ] Опубликовать и проверить production без тестового расходования LLM-токенов.
