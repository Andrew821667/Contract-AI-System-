...
**Статус:** Унификация бренда AI Verdict и SEO-оптимизация Contract AI.
**Ветка:** test/unified-brand-seo

---

## ТЕКУЩАЯ ЗАДАЧА — ЕДИНЫЙ БРЕНД И SEO

**Цель:** привести публичный вход и авторизованный интерфейс Contract AI к утверждённой стилистике AI Verdict, усилить релевантность публичных страниц по запросам о проверке договоров и исключить служебные маршруты из поиска.

**Границы:** не менять аутентификацию, договорную логику, тарифные расчёты и API. Индексировать `/`, `/pricing`, `/demo`, `/privacy`, `/terms`; не индексировать вход, регистрацию, API, админку и рабочее пространство.

- [x] Проверены production-интерфейс, метаданные, sitemap, robots и общий каркас приложения.
- [x] Добавлен утверждённый знак Verdict Frame и единые amber/cyan/graphite токены.
- [x] Обновлены главная с формой входа, регистрация, тарифы, demo, legal-страницы и chrome кабинета.
- [x] Добавлены FAQ-контент, структурированные данные и расширенные crawler rules.
