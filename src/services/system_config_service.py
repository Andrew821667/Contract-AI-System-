...
from src.core.llm_models import DEEPSEEK_FLASH_MODEL, normalize_standard_model_name
...
class SystemConfigService:
    ...
    async def get_router_config(self) -> Dict[str, Any]:
        ...
        if config:
            config = dict(config)
            config["default_model"] = normalize_standard_model_name(
    ...
    async def update_router_config(
        ...
        if default_model is not None:
            current_config["default_model"] = normalize_standard_model_name(default_model)
