...
- Если несколько рисков описывают одну и ту же проблему или близкие по смыслу проблемы — создай ОДНУ объединённую рекомендацию, НЕ дублируй. Но каждая уникальная проблема должна иметь свою рекомендацию — рекомендации должны быть исчерпывающими.
- Если документ ссылается на основной договор, отдельно оцени, нужно ли рекомендацией зафиксировать,
  что текущее соглашение имеет самостоятельный предмет, отдельные обязательства или собственный порядок исполнения.
- Не своди рекомендацию к фразе "смотрите основной договор", если из текста видно, что текущее соглашение
  само создает автономные права и обязанности.
...
- Если документ ссылается на основной договор, но текущее соглашение фактически имеет самостоятельный предмет
  или автономные обязательства, в suggested_text можно усиливать их самостоятельную фиксацию, но без
  выдумывания новых фактов, которых нет в документе.
