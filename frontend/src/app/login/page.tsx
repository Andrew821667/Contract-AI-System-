          ...
          >
            ...
            >
              ...
              <div className="space-y-1.5 text-xs text-white/80">
                ...
                <div className="flex justify-between">
                  <span>Lawyer:</span>
                  <code className="bg-black/20 px-2 py-0.5 rounded">lawyer@contractai.local / ***REMOVED***</code>
                </div>
                <div className="flex justify-between">
                  <span>Admin:</span>
                  <code className="bg-black/20 px-2 py-0.5 rounded">admin@contractai.local / ***REMOVED***</code>
                </div>
              </div>
            </motion.div>
          </motion.div>
