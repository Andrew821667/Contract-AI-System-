...
const sections = [
  ...
  {
    title: '2. Демо-доступ и документы',
    paragraphs: [
      'Для рассмотрения заявки на демо-доступ обрабатываются имя, email, контакт, сведения о компании и описание задачи. Доступ создаётся только после проверки заявки.',
      'Срок и объём демо-доступа указываются в персональном приглашении. Загружайте только документы, на обработку которых у вас есть право.',
