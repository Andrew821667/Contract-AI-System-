    ...
    <main className="brand-surface min-h-screen px-4 py-12 text-slate-900">
      ...
      <article className="brand-panel relative mx-auto w-full max-w-4xl rounded-3xl p-6 md:p-10">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 gap-3 text-left mb-6">
            {[
              ...
              <div key={text} className="flex items-center gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700">
          ...
          <div className="flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Link className="rounded-xl border border-primary-500 px-6 py-3 font-semibold text-primary-700 hover:bg-primary-50" href="/#login">
              Уже есть аккаунт
            </Link>
          </div>
        </div>
        ...
        <section className="mt-12 border-t border-slate-200 pt-10">
          <h2 className="text-2xl font-bold text-slate-900">Как проверить сервис на своем договоре</h2>
        ...
        <section className="mt-10 grid gap-6 md:grid-cols-2">
          <div>
            <h2 className="text-2xl font-bold text-slate-900">Что оценивать в результате</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900">Важное ограничение</h2>
        ...
        <nav className="mt-10 flex flex-wrap gap-5 border-t border-slate-200 pt-6 text-sm">
          <Link className="font-semibold text-primary-700 hover:text-primary-800" href="/pricing">Посмотреть тарифы</Link>
          <Link className="font-semibold text-primary-700 hover:text-primary-800" href="/privacy">Политика конфиденциальности</Link>
          <Link className="font-semibold text-primary-700 hover:text-primary-800" href="/terms">Условия использования</Link>
        </nav>
      </article>
    </main>
  )
