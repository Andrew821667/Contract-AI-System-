...
const defaultActions: QuickAction[] = [
  ...
  { label: 'Предложи условие', prompt: 'Предложи дополнительные защитные условия для этого договора', icon: '📝' },
  { label: 'Создай резюме', prompt: 'Создай краткое резюме ключевых условий этого договора', icon: '📋' },
  { label: 'Извлеки условия', prompt: 'Извлеки и классифицируй все условия из этого договора', icon: '📑' },
  { label: 'Найди в базе', prompt: 'Найди похожие условия в базе знаний и сравни с текущим договором', icon: '🗃️' },
